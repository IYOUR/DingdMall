...
<div id="content" class="panel">
	...
	<li><img  style="margin-right: 50px;" src="../images/<?php echo $goods_image ?>.jpg" alt="goods"></li>
	<li><img src="../images/<?php echo $goods_image ?>.jpg" alt="goods"></li>
	</ul>
	</ul>
 <div class="panel">
